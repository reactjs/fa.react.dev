...
سینتکس کوتاه [`<>...</>` فرگمنت](/reference/react/Fragment) به شما اجازه نمی‌دهد که کلیدی را ارسال کنید، بنابراین شما باید آن‌ها را یا در یک `<div>` واحد گروه‌بندی کنید، یا از سینتکس کمی بلندتر و [واضح‌تر `<Fragment>` استفاده کنید:](/reference/react/Fragment#rendering-a-list-of-fragments)
...
### کجا باید `key` خود را بگیرید؟ {/*where-to-get-your-key*/}
...
شما باید یا `map` را به یک حلقه دستی تبدیل کنید، یا از یک فرگمنت استفاده کنید.
