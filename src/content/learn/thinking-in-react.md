...
```
<p dir="rtl">
شما می‌توانید شروع به دیدن نحوه‌ی رفتار برنامه‌ی خود کنید. مقدار اولیه filterText را از useState('') به useState('fruit') در کد محیط آزمایشی زیر ویرایش کنید. شما خواهید دید که هر دو متن ورودی جستجو و جدول به‌روزرسانی می‌شوند.
</p>
<Sandpack>
