...
شاید یک برنامه تک صفحه‌ای با ری‌اکت بسازید، ولی ری‌اکت به عنوان نیاز اصلی نیست. ری‌کت میتواند برای بهبود قسمت کوچکی از وبسایت حاضر با تعاملی افزوده استفاده شود. کد ری‌اکت می‌تواند به شکل مسالمت آمیزی با مارکاپ رندر شده سمت سرور توسط زبانی مثل PHP یا کتابخانه‌های سمت کاربر هم زیستی کند. در واقع، این دقیقا دلیلیست که ری‌اکت در فیس‌بوک استفاده می‌شود.
...
Package managerها ابزارهایی هستند که به شما امکان می‌دهند تا وابستگی‌های پروژه را مدیریت کنید. [npm](https://www.npmjs.com/) و [Yarn](https://yarnpkg.com/) دو Package managerای هستند که عموما در برنامه‌های ری‌اکت استفاده شده‌اند. هر دوی آنها به نوعی موکل‌های فهرست ثبت بسته NPM هستند.

## CDN {#cdn}

CDN مخخف Content Delivery Network (شبکه تحویل‌دهی محتوا) است. CDNها محتوای cach شده یا ایستایی یک شبکه از سرور‌ها در سراسر دنیا را تحویل می‌دهند.
