...
این پکیج یک رندرر، که می‌تواند برای رندر کردن کامپوننت‌های ری‌اکت مانند آبجکت‌های خالص جاوااسکریپت، بدون واسبتگی به DOM یا محیط محلی یک موبایل استفاده شود را فراهم می‌کند.
