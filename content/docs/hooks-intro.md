...
### استفاده از منطق وابسته به state میان کامپوننت چند کامپوننت دشوار است {#its-hard-to-reuse-stateful-logic-between-components}
