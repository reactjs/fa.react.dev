---
title: "ری اکت نسخه 17.0.0"
author: [gaearon,rachelnabors]
---

امروز ، نسخه 17 ری اکت را منتشر میکنیم ! ما درباره منتشر کردن ری اکت نسخه 17 و تغییراتی که در آن ایجاد شده است به طور مفصل  در  [پست نسخه برگزیده ی انتشار ری اکت 17.0.0](/blog/2020/08/10/react-v17-rc.html)صحبت کرده ایم . این پست خلاصه ای از آن است ، بنابراین اگر پست قبلی راجب به نسخه برگزیده ی انتشار ری اکت 17.0.0 را خوانده اید ، میتواند از خواندن این پست صرف نظر کنید.

## قابلیت جدیدی وجود ندارد

نسخه 17 ری اکت به دلیل اینکه هیچ قابلیت رو به توسعه جدیدی ندارد ، غیرمعمول بنظر میرسد در عوض در این نسخه در درجه اول تمرکز بر روی **آسان تر کردن بهبود ری اکت است**.

به خصوص , ری اکت نسخه 17 یک انتشار "سکویی" است  که جاسازی یک درختی که توسط یک نسخه از ری اکت مدیریت میشود را درون درختی دیگر که توسط نسخه ی متفاوت دیگری اداره میشود را ممکن میسازد

همچنین این نسخه از ری اکت میتواند قرار گیری ری اکت درون دیگر اپلیکیشن هایی که با تکنولوژی های دیگر ساخته شده اند را ممکن سازد.

## ارتقا تدریجی 

**ری اکت نسخه 17 قابلیت ارتقا تدریجی در ری اکت را فعال کرده است** زمانی که شما از ری اکت نسخه 15 به 16 (یا در این زمان از نسخه 16 به 17 ) ارتقا می دهید, شما تمام اپلیکیشن را یکباره بروز میکنید.این مورد میتواند در بسیاری از اپلیکیشن ها به خوبی کار کند اما اگر کد های شما چندین سال پیش نوشته شده باشد و به طور فعال از آن نگهداری نشده باشد ، میتواند بسیار چالش برانگیز باشید ، در حالی که ممکن است دو نسخه متفاوت از ری اکت درون یک صفحه وجود داشته باشد ، تا زمان انتشار ری اکت نسخه 17 این مورد یکی از موارد شکنندگی و بروز مشکلاتی در رویداد ها بشمار میرفت.

ما اکثر این مشکلات را با ری اکت 17 برطرف کرده ایم. این بدان معنی است که **زمانی که ری اکت نسخه 18 و نسخه های آینده ری اکت منتشر شود ، شما گزینه های بیشتری خواهید داشت**. اولین گزینه ارتقا یکباره ی کل اپلیکیشن است ، شبیه به چیزی که قبلا اتفاق می افتاد. اما حالا شما گزینه ی دیگری برای ارتقا اپلیکیشن خود به شکل نکه تکه دارید  ، به طور مثال شما می خواهید اکثریت اپلیکیشن خود را به نسخه 18 ری اکت بروز کنید اما میخواهید یک نسخه از ری اکت 17 را به عنوان lazy-loaded یا زیر مجموعه نگهداری کنید.

 این مورد به معنی این نیست که شما *مجبورید* اپلیکیشن خود را به شکل تدریجی ارتقا بدهید. بلکه **ارتقا یکباره ی کل اپلیکیشن برای بیشتر اپلیکیشن ها بهترین راهکار است** اجرای همزمان دو نسخه از ری اکت حتی اگر یکی از آن ها به شکل lazy-load اجرا بشوند نیز هنوز ایده آل نیست.اگرچه برای اپلیکیشن های بزرگی که دیگر به طور فعالانه نگهداری نمیشوند این گزینه می تواند منطقی بنظر برسد و ری اکت نسخه 17 به این دسته از اپلیکیشن ها اجازه عقب افتادن نمیدهد.

ما یک [مثال در مخزن](https://github.com/reactjs/react-gradual-upgrade-demo/) آماده کرده ایم که چگونه یک نسخه قدیمی از ری اکت را اگر لازم است به شکل lazy load اجرا کنید. این پیش نمایش از Create React App استفاده میکند . اما با دیگر راهکار های مشابه که از ابزار های دیگری استفاده میکنند نیز این امر ممکن است ، ما از دیگر پیش نمایش هایی که با ابزار های دیگر به عنوان pull Request برای ما ارسال شود ، استقبال میکنیم.

>یادداشت
>
>ما **تغییرات دیگر را** به بعد از نسخه 17 ری اکت به موکول کرده ایم. هدف از انتشار این نسخه فعال کردن قابلیت ارتقا تدریجی است . اگر ارتقا به ری اکت 17 پیچیده شود هدف آن با شکست روبرو خواهد شد.

## تغییر در محول کننده رویداد ها

برای فعال کردن قابلیت ارتقا تدریجی, ما به کمی تغییر در سیستم رویداد های ری اکت نیاز داشتیم. ری اکت 17 یک انتشار بزرگی  است به این علت که این تغییرات با اهمیت هستند. شما میتوانید  [سوالات متداول مارا نسبت به این موضوع](/docs/faq-versioning.html#breaking-changes)  را بخوانید تا درباره تعهد ما نسبت به ثبات این تغییرات اطلاعت لازم را بدست آورید.

ری اکت 17 دیگر هیچ رویدادی را به سطح `document`متصل نمیکند. در عوض, آن را به Root DOM  ای که درخت ری اکت از آن رندر میشود ، متصل می گردد:
...
در ری اکت 16 و قبل تر , ری اکت برای اکثر رویداد هایش از `document.addEventListener()` استفاده میکرد. ری اکت 17 با صدا زدن `rootNode.addEventListener()` این کار را در پشت پرده انجام می دهد.

![یک دیاگرام که نشان میدهد که چگونه ری اکت 17 رویداد ها را به Root به جای Document متصل میکند](../images/blog/react-v17-rc/react_17_delegation.png)
...
[در پست معرفی ری اکت 17 نسخه برگزیده انتشار  ،](/blog/2020/08/10/react-v17-rc.html#other-breaking-changes) ما تغییرات اساسی موجود در ری اکت 17 را توضیح داده ایم .

ما با توجه به تغییرات صورت گرفته تنها مجبور به تغییر کمتر از بیست کامپوننت از صد هزار کامپوننت موجود در FaceBook شدیم, بنابراین **ما انتظار داریم که اکثر اپلیکیشن ها بتواننده بدون مشکل به نسخه 17 از ری اکت ارتقا پیدا کنند**. لطفا اگر به مشکلی برخورد کردید [آن را با ما در میان بزارید](https://github.com/facebook/react/issues) .

## تغییر شکل جدید JSX

ری اکت 17 از [تغییر شکل جدید JSX](/blog/2020/09/22/introducing-the-new-jsx-transform.html) پشتیبانی میکند. ما همچنین در نسخه 16.14.0 و 15.7.0 و 0.14.10 از این قابلیت پشتیبانی خواهیم کرد و به این مورد توجه کنید که این قابلیت کاملا اختیاری است و شما مجبور به استفاده از آن نیستید . تغییر شکل قبلی JSX را میتوانید همچنان استفاده کنید و برنامه ای برای حذف پشتیبانی از آن وجود ندارد .

## ری اکت نیتیو

ری اکت نیتیو برنامه زمانی مشخصی برای انتشار دارد. ما در حال حاضر انتظار پشتیبانی از ری اکت 17 برای استفاده در ری اکت نیتیو 0.65 داریم ، اما نسخه دقیق آن باید تغییر کند . مثل همیشه شما میتوانید بحث های مربوط به انتشار ری اکت نیتیو را در انجمن مربوط به آن  , [پیگیری کنید](https://github.com/react-native-community/releases).
