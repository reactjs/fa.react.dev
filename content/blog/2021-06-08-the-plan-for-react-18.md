...
## چه چیزهایی در ری‌اکت ۱۸ می‌آیند؟ {#چه-چیزهایی-در-ریاکت-۱۸-میآیند؟}
...
## یک استراتژی پذیرش تدریجی {#یک-استراتژی-پذیرش-تدریجی}
...
## همکاری با جامعه ری‌اکت {#همکاری-با-جامعه-ریاکت}
...
## دسترسی به گروه کاری ری‌اکت ۱۸ {#دسترسی-به-گروه-کاری-ریاکت-۱۸}
...
## چگونه ری‌اکت ۱۸ آلفا را امروز امتحان کنیم {#چگونه-ریاکت-۱۸-آلفا-را-امروز-امتحان-کنیم}
...
## خط زمانی پیشبینی‌شده انتشار ری‌اکت ۱۸ {#خط-زمانی-پیشبینیشده-انتشار-ریاکت-۱۸}
